...
export default function AboutPage() {
    ...
    console.log("Navbar:", Navbar); // Should not be an object

  return (
    <>
      <Head>
        <title>About Us | Buyzaar</title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        <meta name="description" content="Learn about Buyzaar's mission to empower e-commerce for both buyers and sellers." />
      </Head>
      <Navbar />
      <main className="px-4 sm:px-6 md:px-16 lg:px-32 pt-16 pb-24 space-y-24 bg-white text-gray-800">
        ...
        <MotionSection
          ...
          className="relative w-full h-[400px] sm:h-[500px] bg-cover bg-center bg-no-repeat flex items-center justify-center"
          style={{ backgroundImage: "url('/packaging.jpg')" }}
        >
          <div className="absolute inset-0 bg-black/40"></div>
          <div className="relative z-10 max-w-4xl mx-auto text-center px-4 sm:px-8 md:px-12">
            <h1 className="text-2xl sm:text-4xl md:text-5xl font-bold text-white mb-4 leading-snug">
        ...
        >
          <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 items-start">
            <div className="lg:w-1/2 pl-0 md:pl-6 lg:pl-12 xl:pl-20">
              <h3 className="text-2xl font-semibold mb-4 text-indigo-700">Helping Buyers</h3>
              <ul className="list-disc ml-5 text-gray-700 space-y-2">
                {[
                  "Quick product discovery with responsive search",
                  "Streamlined checkout process with secure payments",
                  "Track orders in real-time from dashboard",
                  "Multi-device experience for mobile-first shoppers",
                ].map((item, index) => (
                  <MotionLi
                    key={index}
        ...
        >
          <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 items-start">
            ...
            <div className="lg:w-1/2 order-1 lg:order-2">
              ...
              <ul className="list-disc ml-5 text-gray-700 space-y-2">
                {[
                  "Product & order management via seller dashboard",
                  "Sales analytics to optimize performance",
                  "Manage inventory and pricing on the go",
                  "Instant upload with image preview and editing",
                ].map((item, index) => (
                  <MotionLi
                    key={index}
                    initial={{ opacity: 0, x: 20 }}
        ...
        <MotionSection
          ...
          viewport={{ once: true }}
          className="py-20 px-4 sm:px-6 md:px-16 lg:px-32"
        >
          <h2 className="text-2xl font-semibold text-gray-800 mb-12 text-center">Our Journey</h2>
          <div className="relative grid sm:grid-cols-2 md:grid-cols-4 gap-10 sm:gap-8 text-gray-700 max-w-7xl mx-auto">
            {[
              { date: "2023", title: "Buyzaar Launched", desc: "Started with a goal to bridge buyer-seller gaps through modern tools." },
              { date: "2024", title: "Seller Dashboard Released", desc: "Empowering sellers with tools to grow and manage efficiently." },
              { date: "2024", title: "Mobile Optimization", desc: "Built for all screens, making commerce accessible anytime, anywhere." },
              { date: "2025", title: "Next.js 14 Upgrade", desc: "Improved performance, stability, and development speed." },
            ].map((item, index, arr) => (
              <div key={index} className="relative text-center px-4 flex flex-col items-center">
                <div className="relative flex items-center justify-center mb-2">
                  <span className="w-2 h-2 rounded-full bg-indigo-600 inline-block mr-2"></span>
                  <span className="text-sm font-semibold text-indigo-600 z-10">{item.date}</span>
                  {index !== arr.length - 1 && (
                    <div className="hidden md:block absolute top-1/2 left-full w-10 md:w-16 h-px bg-gray-300 ml-2" />
                  )}
                </div>
        ...
        <MotionSection
          ...
          transition={{ duration: 0.6 }}
          viewport={{ once: true }}
          className="bg-gradient-to-br from-indigo-800 via-indigo-700 to-indigo-800 text-white px-4 sm:px-6 md:px-16 lg:px-32 py-16 rounded-lg"
        >
          ...
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              <div key={i} className="bg-white/5 p-6 rounded-lg shadow-lg hover:shadow-xl transition duration-300">
        ...
        <MotionSection
          ...
          transition={{ duration: 0.5 }}
          viewport={{ once: true }}
          className="bg-white px-4 sm:px-6 md:px-16 lg:px-32 py-20"
        >
          <div className="max-w-3xl mx-auto text-center space-y-6 sm:space-y-8">
            ...
            <p className="text-sm sm:text-base text-gray-500 uppercase tracking-widest font-medium">
